...
Source2:	PackageKit.ini

# Fedora-specific: set Vendor.conf up for Fedora.
Patch0:    PackageKit-0.3.8-Fedora-Vendor.conf.patch
Patch2:	not-rhel.patch
#Patch3:	pk-yum-backend-for-sl.patch
#Patch4:	use-sl-upgrade.patch
#Patch5:	pk-upgrade-distro.patch
Patch6:	eurolinux.patch
...
%changelog
* Wed Nov 28 2018 Aleksander Baranowski <aleksander.baranowski@euro-linux.com>
- Revert changes from SL - only not-rhel.patch is needed.
- Add eurolinux.patch
* Tue Oct 30 2018 Scientific Linux Auto Patch Process <SCIENTIFIC-LINUX-DEVEL@LISTSERV.FNAL.GOV>
- Added Patch: not-rhel.patch
-->  SL is not RHEL
- Added Patch: pk-upgrade-distro.patch
-->  Use /usr/sbin/sl7-upgrade rather than preupgrade
- Added Source: PackageKit.ini
-->  Config file for automated patch script
- Added Patch: pk-yum-backend-for-sl.patch
-->  Add in code to let PackageKit check dist to upgrade
- Added Patch: use-sl-upgrade.patch
-->  Use /usr/sbin/sl7-upgrade rather than preupgrade
